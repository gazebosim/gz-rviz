...
#ifndef IGNITION__RVIZ__PLUGINS__MARKERARRAYDISPLAY_HPP_
#define IGNITION__RVIZ__PLUGINS__MARKERARRAYDISPLAY_HPP_
...
{
/**
 * @brief Renders data from visualization_msgs::msg::MarkerArray message
 */
class MarkerArrayDisplay : public MessageDisplay<visualization_msgs::msg::MarkerArray>
{
  Q_OBJECT
...
public:
  /**
   * Constructor for MarkerArray visualization plugin
   */
  MarkerArrayDisplay();
  ...
  // Documentation Inherited
  void callback(const visualization_msgs::msg::MarkerArray::SharedPtr _msg) override;
...
protected:
  /**
   * @brief Update MarkerArray data visualization
   */
...
#endif  // IGNITION__RVIZ__PLUGINS__MARKERARRAYDISPLAY_HPP_
