...
public:
  ...
  CovarianceVisual(
    ignition::rendering::VisualPtr parent_visual, CovarianceUserData user_data, std::string);
...
private:
  ...
  // reference of orientation ellipse scalings
  std::array<ignition::rendering::NodePtr, kNumOrientationShapes> orientation_offset_nodes_;
