...
public:
   ...
   */
  bool getFramePose(const std::string & _frame, math::Pose3d & _pose);
   ...
   * @return Pose validity (true if pose is valid, else false)
   */
  bool getParentPose(const std::string & _child, math::Pose3d & _pose);
...
private:
  ...
  std::unordered_map<std::string, math::Pose3d> tfTree;
...
#endif  // GZ__RVIZ__COMMON__FRAME_MANAGER_HPP_
